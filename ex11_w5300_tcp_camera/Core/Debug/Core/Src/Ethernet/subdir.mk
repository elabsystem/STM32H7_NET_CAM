...
clean-Core-2f-Src-2f-Ethernet:
	-$(RM) ./Core/Src/Ethernet/socket.d ./Core/Src/Ethernet/socket.o ./Core/Src/Ethernet/socket.su ./Core/Src/Ethernet/wizchip_conf.d ./Core/Src/Ethernet/wizchip_conf.o ./Core/Src/Ethernet/wizchip_conf.su
